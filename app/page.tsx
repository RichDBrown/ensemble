...
export default function LandingPage() {
  return (
    <main className="flex flex-col items-center gap-y-21 pt-16 pb-6 md:pb-16 px-4">
      <section className="flex flex-col items-center w-full md:max-w-139.75">
        ...
        <h2 className="mt-16 text-3xl md:text-6xl font-medium">
          Never Cram Again
        </h2>
        <p className="mt-4 text-xl text-center text-on-surface-variant">
          A smarter way to study, built on learning science, not last-minute
          stress.
        </p>
        <Link
          href="/dashboard"
          className="flex items-center justify-center mt-6 w-full h-12 md:h-14 text-sm font-medium text-on-primary bg-primary rounded-2xl hover:bg-[#AFCFFB] active:bg-[#AFCFFB] transition-colors"
        >
          Get started
        </Link>
      </section>
      <section className="flex flex-col items-center w-full md:max-w-205.75">
        <h2 className="text-center text-3xl md:text-6xl font-medium">
      ...
      <section className="flex flex-col items-center w-full md:max-w-205.75">
        ...
        <Link
          href="/dashboard"
          className="flex items-center justify-center md:hidden mt-6 w-full h-12 text-sm font-medium text-on-primary bg-primary rounded-2xl hover:bg-[#AFCFFB] active:bg-[#AFCFFB] transition-colors"
        >
          Build my study plan
        </Link>
      </section>
      ...
      <section className="flex flex-col items-center w-full md:max-w-205.75">
        ...
        <p className="mt-4 text-xl md:text-xl text-on-surface-variant">
          Never cram again.
        </p>
        <Link
          href="/dashboard"
